...
<?php endif; ?>
    <div id="register" class="container bg-white p-4 rounded shadow mt-2">
        <form method="POST" autocomplete="on" action="<?php echo e(url('/update_equipment', $inventory->id)); ?>"
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="title" name="title" value="<?php echo e($inventory->title); ?>" type="text" required
                        autofocus class="form-control" placeholder=" ">
                    <label for="title">Equipment Title</label>
                </div>
                <div class="col-md-6">
                    <input id="description" name="description" value="<?php echo e($inventory->description); ?>" type="text"
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="price" name="price" value="<?php echo e($inventory->price); ?>" type="text" required
                        class="form-control" placeholder=" ">
                    <label for="price">Equipment Price</label>
                </div>
                <div class="col-md-6">
                    <input id="quantity" name="quantity" value="<?php echo e($inventory->quantity); ?>" type="number" required
                        class="form-control" placeholder=" ">
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="category" name="category" value="<?php echo e($inventory->category); ?>" type="text" required
                        class="form-control" placeholder=" ">
                    <label for="category">Equipment Category</label>
                </div>
                <div class="col-md-6">
                    <input id="serial_number" name="serial_number" value="<?php echo e($inventory->serial_number); ?>"
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="qr_code" name="qr_code" value="<?php echo e($inventory->qr_code); ?>" type="number" required
                        class="form-control" placeholder=" ">
                    <label for="qr_code">Equipment QR Code</label>
                </div>
                <div class="col-md-6">
                    <input id="condition" name="condition" value="<?php echo e($inventory->condition); ?>" type="text" required
                        class="form-control" placeholder=" ">
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="image-input">
                        <img height="auto" width="100px" src="/inventory/<?php echo e($inventory->image); ?>"
                            alt="Equipment Image">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input id="purchase_date" name="purchase_date" value="<?php echo e($inventory->purchase_date); ?>"
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/updateinventory.blade.php ENDPATH**/ ?>