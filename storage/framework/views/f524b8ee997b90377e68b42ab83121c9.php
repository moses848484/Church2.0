...
<body>
    <footer class="footer2">
        ...
        <p class="buttonlayout">
            <a class="btn btn-success mx-2" href="/departments"><i class="fas fa-sitemap"></i> Departments</a> <a class="btn btn-success mx-2" href="<?php echo e(url('/insert_strategicplan')); ?>"><i
                    class="fa fa-plus"></i> Technical Plan</a> 
                    <a class="btn btn-success mx-2" href="<?php echo e(route('download.strategic.plan')); ?>">
    ...
    <div id="block_bg" class="block">
        ...
        <div id="register" class="form-container">
            <form method="POST" autocomplete="on" action="<?php echo e(url('/strategic_plan_table')); ?>">
                <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $department; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($item->strategic_areas); ?></td>
                                    <td><?php echo e($item->strategic_theme); ?></td>
                                    <td><?php echo e($item->strategic_objectives); ?></td>
                                    <td><?php echo e($item->kpis); ?></td>
                                    <td><?php echo e($item->initiatives); ?></td>
                                    <td style="background-color: <?php echo e($item->status_color); ?>; width: 50px; height: 50px;">
                                        <!-- You can set fixed width and height for better visibility -->
                                    </td>
                                    <td><?php echo e($item->total_target); ?></td>
                                    <td><?php echo e($item->q1); ?></td>
                                    <td><?php echo e($item->q2); ?></td>
                                    <td><?php echo e($item->q3); ?></td>
                                    <td><?php echo e($item->q4); ?></td>
                                    <td><?php echo e($item->budget_per_initiative); ?></td>
                                    <td><?php echo e($item->explanation_of_variation); ?></td>
                                    <td><?php echo e($item->resource_persource); ?></td>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are You Sure You Want To Delete This Member')"
                                            class="btn btn-danger" href="<?php echo e(url('delete_strategicplan', $item->id)); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\church\resources\views/auth/firstquoter.blade.php ENDPATH**/ ?>