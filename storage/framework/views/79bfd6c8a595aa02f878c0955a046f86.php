...
<body>
    <footer class="footer2">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted3 d-block text-center text-sm-left d-sm-inline-block"><i class="fa-solid fa-circle-info"></i>&nbsp;Number Of Equipment:<span class="badge badge-info"> <?php echo e($inventoryCount); ?></span></span>
        </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->qr_code); ?></td>
                                <td>
                                    <img src="/inventory/<?php echo e($item->image); ?>" alt="<?php echo e($item->title); ?>" style="width: 100px; height: auto;">
                                </td>
                                <td><?php echo e($item->purchase_date->format('Y-m-d H:i:s')); ?></td>
                                <td>
                                    <a onclick="return confirm('Are You Sure You Want To Delete This Equipment')" class="btn btn-danger" href="<?php echo e(url('delete_inventory', $item->id)); ?>">
                                        <i class="fa-solid fa-trash icon-medium"></i> Delete
                                    </a>
                                </td>
                                <td>
                                    <a class="btn btn-success" href="<?php echo e(url('/update_inventory', $item->id)); ?>">&nbsp;&nbsp;
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/show_inventory.blade.php ENDPATH**/ ?>