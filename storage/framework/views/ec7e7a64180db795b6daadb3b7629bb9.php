...
<?php endif; ?>
    <div id="register" class="container bg-white p-4 rounded shadow mt-2">
        <form method="POST" action="<?php echo e(url('/add_strategicplan')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/addstrategicplan.blade.php ENDPATH**/ ?>