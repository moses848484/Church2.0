                    ...
                    <?php if(session()->get('notify.type') === 'success'): ?>
                        <div class="flex items-start">
                            <div class="flex flex-col space-y-3 p-4 sm:p-6">
                                ...
                                <h4 class="text-white font-semibold text-xl leading-6"><?php echo e(__('Success')); ?></h4>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="flex justify-end">
                            <div class="flex flex-col space-y-3 p-4 sm:p-6 text-right">
                                ...
                                <h4 class="text-white font-semibold text-xl leading-6"><?php echo e(__('Error')); ?></h4>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Moses Blake Simataa\Videos\Moses Simataa Project Review\Application\church\church\vendor\mckenziearts\laravel-notify\src/../resources/views/notifications/drakify.blade.php ENDPATH**/ ?>