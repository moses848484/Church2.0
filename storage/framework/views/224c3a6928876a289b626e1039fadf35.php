...
<body>
    <footer class="footer2">
        ...
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted3 d-block text-center text-sm-left d-sm-inline-block"><i class="fa-solid fa-circle-info"></i>&nbsp;Number Of Users:<span class="badge badge-info"> <?php echo e($userCount); ?></span></span>
        </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Are You Sure You Want To Delete This Member')" class="btn btn-danger" href="<?php echo e(url('delete_users', $user->id)); ?>"> <i class="fa-solid fa-trash icon-medium"></i>Delete</a>
                                </td>

                                <td>
                                    <a class="btn btn-success" href="<?php echo e(url('/update_user', $user->id)); ?>">&nbsp;&nbsp;
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/seeusers.blade.php ENDPATH**/ ?>