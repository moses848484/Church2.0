                ...
                <?php else: ?>
                    <li class="nav-item">
                        <i class="fas fa-user-circle fa-2x"><a class="btn btn-primary" id="logincss"
                                href="<?php echo e(url('/redirect')); ?>">Log In</a></i>
                        <i class="fas fa-user-plus fa-2x"><a class="btn btn-success"
                                href="<?php echo e(route('register')); ?>">Register</a></i>
                    </li>
                <?php endif; ?>
                <?php endif; ?>
                </ul>
...
<?php /**PATH C:\Users\Moses Blake Simataa\Videos\Moses Simataa Project Review\Application\church\church\resources\views/home/header.blade.php ENDPATH**/ ?>