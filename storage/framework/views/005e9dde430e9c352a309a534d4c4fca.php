...
<div class="container">
    ...
    <a href="<?php echo e(route('scorecards.create')); ?>" class="btn btn-primary">Add Scorecard</a>
    <table class="table">
        <thead>
            <tr>
                <th>Name</th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\church\resources\views/scorecards/index.blade.php ENDPATH**/ ?>