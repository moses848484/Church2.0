...
<body>
    <div class="container-scroller">
        ...
        <!-- partial -->
        <?php echo $__env->make('home.addgiving', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- container-scroller -->
        <!-- plugins:js -->
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/home/givings.blade.php ENDPATH**/ ?>