...
<?php $__env->startSection('content'); ?>
    <style>
        body { background-image: url('../images/cross2.jpg');
    ...
    <div class="container">
        <div class="card">
            ...
            <h1>Add Details</h1>
            <form action="<?php echo e(route('scorecard.storeDetails')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.score', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\church\resources\views/scorecard/details.blade.php ENDPATH**/ ?>