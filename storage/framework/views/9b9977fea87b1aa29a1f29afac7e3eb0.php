...
<?php endif; ?>
    <div id="register" class="form-container">
        <form method="POST" autocomplete="on" action="<?php echo e(url('/update_users', $users->id)); ?>"
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="name" name="name" value="<?php echo e($users->name); ?>" type="text" required autofocus
                        class="form-control" placeholder=" ">
                    <label for="name">Names</label>
                </div>
                <div class="col-md-6">
                    <input id="email" name="email" value="<?php echo e($users->email); ?>" type="text" class="form-control"
                        placeholder=" ">
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="address" name="address" value="<?php echo e($users->address); ?>" type="text" required
                        class="form-control" placeholder=" ">
                    <label for="address">Residence Address</label>
                </div>
                <div class="col-md-6">
                    <input id="phone" name="phone" value="<?php echo e($users->phone); ?>" type="number" required
                        class="form-control" placeholder=" ">
            ...
            <div class="row mb-3">
                <div class="col-md-6 col-sm-6">
                    ...
                    <input id="date" name="birthday" value="<?php echo e($users->birthday); ?>" type="date"
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <select id="gender" name="gender" required class="form-select" placeholder=" ">
                        <option value="" disabled <?php echo e(!$users->gender ? 'selected' : ''); ?>>Gender</option>
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/updateusers.blade.php ENDPATH**/ ?>