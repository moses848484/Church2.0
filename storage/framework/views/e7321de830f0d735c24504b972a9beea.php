...
<body>
    <div class="container">
        <div class="card mt-5 p-4">
            ...
            <form method="POST" action="<?php echo e(route('scorecard.update', $scorecard->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="strategic_theme" class="form-control" name="strategic_theme"
                        value="<?php echo e($scorecard->strategic_theme); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="strategic_area" class="form-control" name="strategic_area"
                        value="<?php echo e($scorecard->strategic_area); ?>">
                </div>
                ...
                <div class="mb-3 mt-3">
                    ...
                    <textarea class="form-control" id="explanation" name="explanation" rows="3"><?php echo e($scorecard->explanation); ?></textarea>
                </div>
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/scorecard/edit.blade.php ENDPATH**/ ?>