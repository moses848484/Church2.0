                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($member->mname); ?></td>
                                    <td><?php echo e($member->lname); ?></td>
                                    <td><?php echo e($member->gender); ?></td>
                                    <td><?php echo e($member->address); ?></td>
                                    <td><?php echo e($member->marital); ?></td>
                                    <td><?php echo e($member->birthday); ?></td>
                                    <td><?php echo e($member->ministry); ?></td>
                                    <td><?php echo e($member->mobile); ?></td>
                                    <td><?php echo e($member->registeras); ?></td>
                                    <td><?php echo e($member->registrationdate); ?></td>
                                    <td><?php echo e($member->email); ?></td>
                                    <td><?php echo e($member->document); ?></td>
                                    <td>
                                        <a onclick="return confirm('Are You Sure You Want To Delete This Member')"
                                            class="btn btn-danger" href="<?php echo e(url('delete_members', $member->id)); ?>">
                                            <i class="fa-solid fa-trash icon-medium"></i>Delete
                                        </a>
                                    </td>
                                    <td>
                                        <a class="btn btn-success" href="<?php echo e(url('/update_member', $member->id)); ?>">
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/seemember.blade.php ENDPATH**/ ?>