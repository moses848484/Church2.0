        ...
        <div class="flipper h-100 position-relative">
          ...
          <div class="front text-area6 h-100 overflow-auto">
            ...
            <audio id="audioPlayer" style="width: 100%;" controls>
              <source id="audioSource" src="<?php echo e(asset('music/Bill When I Cry.mp3')); ?>" type="audio/mpeg">
  ...
  const tracks = [
    {
      ...
      file: "<?php echo e(asset('music/Gaither Vocal Band - Im Not Gonna Worry [Live] ft. Gaither Vocal Band.mp3')); ?>"
    },
    {
      title: "When I Cry",
      file: "<?php echo e(asset('music/Bill When I Cry.mp3')); ?>"
    },
    {
      title: "Count On Me",
      file: "<?php echo e(asset('music/14 Whitney Houston - Count On Me.mp3')); ?>"
    }
  ];
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/home/songs.blade.php ENDPATH**/ ?>