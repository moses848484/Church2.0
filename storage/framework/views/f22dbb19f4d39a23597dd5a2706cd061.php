    ...
    <footer class="footer2">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted4 d-block text-center text-sm-left d-sm-inline-block"><i
                    class="fa-solid fa-user"></i>&nbsp; User Givings</span>
        </div>

        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted3 d-block text-center text-sm-left d-sm-inline-block"><i
                    class="fa-solid fa-circle-info"></i>&nbsp;Number Of Givings:<span class="badge badge-info">
                    <?php echo e($givingCount); ?></span></span>
        </div>
            ...
            <form method="POST" autocomplete="on" action="<?php echo e(url('/add_members')); ?>">
                ...
                <div class="table-wrapper">
                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                        ...
                        <tbody>
                            <?php $totalamount = 0; ?>
                            <?php $__currentLoopData = $givings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $give): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($give->id); ?></td>
                                    <td><?php echo e($give->fname); ?></td>
                                    <td><?php echo e($give->mname); ?></td>
                                    <td><?php echo e($give->lname); ?></td>
                                    <td><?php echo e($give->giving); ?></td>
                                    <td><?php echo e($give->amount); ?></td>
                                    <td><?php echo e($give->mobile); ?></td>
                                    <td><?php echo e($give->comment); ?></td>
                                    <td>
                                        <a onclick="return confirm('Are You Sure You Want To Delete This Member')"
                                            class="btn btn-danger" href="<?php echo e(url('delete_givers', $give->id)); ?>"> <i
                                                class="fa-solid fa-trash icon-medium"></i>Delete</a>
                                    </td>
                                </tr>
                    ...
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted4 d-block text-center text-sm-left d-sm-inline-block">&nbsp;Total
                            K<?php echo e($totalamount); ?> </span>
                    </div>
                </div>
        </div>
        </form>
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/seegivers.blade.php ENDPATH**/ ?>