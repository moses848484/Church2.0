...
<body>
    <div class="container">
        <div class="card mt-5 p-4">
            ...
            <form method="POST" action="<?php echo e(route('strategic_plan.update', $score->id)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="strategic_theme" class="form-control" name="strategic_theme"
                        value="<?php echo e($score->strategic_theme); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="strategic_area" class="form-control" name="strategic_area"
                        value="<?php echo e($score->strategic_area); ?>">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="budget_perinitiative" class="form-control" name="budget_perinitiative"
                        value="<?php echo e($score->budget_perinitiative); ?>">
                </div>

                <div class="mb-3">
                    <label for="comments" class="form-label">Comments</label>
                    <textarea id="comments" class="form-control" name="comments" rows="3"><?php echo e($score->comments); ?></textarea>
                </div>
                ...
                <div class="signbtn">
                    <a href="<?php echo e(url('/strategic_plan')); ?>" class="to_register">
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/strategic_plan/edit.blade.php ENDPATH**/ ?>