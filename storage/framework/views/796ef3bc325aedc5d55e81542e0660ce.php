...
<?php endif; ?>
    <div id="register" class="container bg-white p-4 rounded shadow mt-2">
        <form method="POST" autocomplete="on" action="<?php echo e(url('/add_inventory')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>

            <div class="text-center mb-4">
                <img src="/images/sda.png" class="sda_logo mb-3" alt="Logo" style="width: 55px;">
                <h2 class="text-primary">Add Equipment</h2>
            </div>

            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="title" name="title" type="text" required autofocus class="form-control"
                        placeholder=" ">
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="price" name="price" type="text" required class="form-control" placeholder=" ">
                    <label for="price">Equipment Price</label>
                </div>

                <div class="col-md-6 ">
                    <input id="quantity" name="quantity" type="number" required class="form-control" placeholder=" ">
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="category" name="category" type="text" required class="form-control" placeholder=" ">
                    <label for="category">Equipment Category</label>
                </div>

                <div class="col-md-6">
                    <input id="serial_number" name="serial_number" type="number" required class="form-control"
                        placeholder=" ">
            ...
            <div class="row mb-3 form-floating">
                <div class="col-md-6">
                    <input id="qr_code" name="qr_code" type="number" required class="form-control" placeholder=" ">
                    <label for="qr_code">Equipment QR Code</label>
                </div>

                <div class="col-md-6">
                    <input id="condition" name="condition" type="text" required class="form-control" placeholder=" ">
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3">
                    <label class="textcolor" for="image" class="form-label">Equipment Image</label>
                ...
                <div class="col-md-6">
                    ...
                    <input id="purchase_date" type="datetime-local" step="1" name="purchase_date" required
                        class="form-control" placeholder=" ">
                </div>
            </div>

            <button type="submit" class="btn btn-success w-100">
                <i class="fa-solid fa-toolbox"></i> Add Equipment
            </button>
        </form>
    </div>
</div>
...
<?php /**PATH C:\xampp\htdocs\church\resources\views/auth/addinventory.blade.php ENDPATH**/ ?>