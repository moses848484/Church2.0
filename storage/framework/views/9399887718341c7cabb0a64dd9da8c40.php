    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <div class="text-area7 bg text-left text-black">
                ...
                <div class="btn-box">
                    <a href="<?php echo e(route('register')); ?>" class="btn3">
                       What to Expect
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="btn4">
...
<?php /**PATH C:\Users\Moses Blake Simataa\Videos\Moses Simataa Project Review\Application\church\church\resources\views/home/prayer.blade.php ENDPATH**/ ?>