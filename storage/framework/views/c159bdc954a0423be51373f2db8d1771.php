                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                ...
                                <div class="footer1">
                                    <a href="<?php echo e(url('weekly_schedule')); ?>" class="text-muted2 font-weight-normal">Schedule
                                        Details</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                ...
                                <div class="footer1">
                                    <a href="<?php echo e(url('weekly_schedule')); ?>" class="text-muted2 font-weight-normal">Timer
                                        Details</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                ...
                                <div class="footer1">
                                    <a href="<?php echo e(url('weekly_schedule')); ?>"
...
</html><?php /**PATH C:\xampp\htdocs\church\resources\views/auth/timeschedule.blade.php ENDPATH**/ ?>